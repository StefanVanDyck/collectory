    ...
    <body>
        ...
        <div id="baseForm" class="body">
            ...
            <g:form  method="post" name="baseForm" action="base">
                ...
                <div class="row mb-3">
                    <label class="offset-sm-2 col-sm-4"><g:message code="shared.eth.th01" /></label>
                ...
                <g:each var="hint" in="${hints}" status="i">
                    <div class="row mb-3">
                        <div class="offset-sm-2 col-sm-4"><g:textField class="form-control" name="rank_${i}" value="${hint.rank.encodeAsHTML()}" /></div>
                ...
                <g:each var="i" in="${[j, j+1, j+2]}">
                    <div class="row mb-3">
                        <div class="offset-sm-2 col-sm-4"><g:textField class="form-control" name="rank_${i}" value="" /></div>
                ...
                <div class="buttons">
                    ...
                    <span class="button"><input type="submit" name="_action_cancel" value="${message(code:"shared.eth.button.cancel")}" class="cancel btn btn-outline-dark"></span>
                </div>
            </g:form>
        </div>
    </body>
