    ...
    <body>
        ...
        <div id="baseForm" class="body">
            ...
            <g:form method="post" name="baseForm" action="base">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2"><g:message code="externalIdentifiers.label" default="Taxonomy hints" /><cl:helpText code="externalIdentifiers"/></label>
                ...
                <div class="buttons">
                    ...
                    <span class="button"><input type="submit" name="_action_cancel" value="${message(code:"shared.ext.button.cancel")}" class="cancel btn btn-outline-dark"></span>
                </div>
            </g:form>
        </div>
    </body>
