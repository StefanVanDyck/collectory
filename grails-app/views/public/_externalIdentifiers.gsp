    ...
    <section class="public-metadata" id="externalIdentifiers">
        ...
        <ul>
            <g:each var="ext" in="${external}">
                <li><g:if test="${ext.identifier}"><a href="https://www.gbif.org/dataset/${ext.identifier}" class="external" target="_blank"><g:fieldValue bean="${ext}" field="label"/></a></g:if><g:else><g:fieldValue bean="${ext}" field="label"/></g:else></li>
            </g:each>
        </ul>
    </section>
</g:if>
