    ...
    <div id="content">
        ...
        <div class="section infoPage">
          ...
          <table class="table">
            ...
            <tr>
              ...
              <td><a href="${grailsApplication.config.grails.serverURL}/ws">${grailsApplication.config.grails.serverURL}/ws</a></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.table01.cell0201" />:</td>
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/institution.json">${grailsApplication.config.grails.serverURL}/ws/institution</a></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.table01.cell0301" />:</td>
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/institution/in0.json">${grailsApplication.config.grails.serverURL}/ws/institution/in0</a></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.table01.cell0401" />:</td>
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/institution/count">${grailsApplication.config.grails.serverURL}/ws/institution/count</a></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.table01.cell0501" />:</td>
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/institution/count/state">${grailsApplication.config.grails.serverURL}/ws/institution/count/state</a></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.table01.cell0601" />:</td>
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/institution/in72/contacts.json">${grailsApplication.config.grails.serverURL}/ws/institution/in72/contacts</a></td>
            </tr>
          </table>
        ...
        <h3 id="WS0025"><g:message code="data.catalogue.ws0025.title" /></h3>
          ...
          <table class="table">
            ...
            <tr>
              ...
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/contacts.json">${grailsApplication.config.grails.serverURL}/ws/contacts</a></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.ws0025.cell0201" /></td>
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/contacts/31.json">${grailsApplication.config.grails.serverURL}/ws/contacts/31</a></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.ws0025.cell0301" /></td>
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/contacts/email/dave.martin@csiro.au">${grailsApplication.config.grails.serverURL}/ws/contacts/email/dave.martin@csiro.au</a></td>
            </tr>
          </table>
          ...
          <table class="table">
            ...
            <tr>
              <td colspan="2"><span class="code"><span class='entity'>GET</span> ${grailsApplication.config.grails.serverURL}/ws/{resource type}/{resource uid}/contacts</span></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.ws0025.forexample" />:</td>
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/collection/co13/contacts.json">${grailsApplication.config.grails.serverURL}/ws/collection/co13/contacts</a></td>
            </tr>
            <tr>
              <td colspan="2"><g:message code="data.catalogue.ws0025.table0301" />:</td>
            </tr>
            <tr>
              <td colspan="2"><span class="code"><span class='entity'>GET</span> ${grailsApplication.config.grails.serverURL}/ws/{resource type}/{resource uid}/contacts/{id}</span></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.ws0025.forexample" />:</td>
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/collection/co13/contacts/20.json">${grailsApplication.config.grails.serverURL}/ws/collection/co13/contacts/20</a></td>
            </tr>
            <tr>
              <td colspan="2"><g:message code="data.catalogue.ws0025.table0501" />:</td>
            </tr>
            <tr>
              <td colspan="2"><span class="code"><span class='entity'>GET</span> ${grailsApplication.config.grails.serverURL}/ws/{resource type}/contacts</span></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.ws0025.forexample" />:</td>
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/collection/contacts.json">${grailsApplication.config.grails.serverURL}/ws/collection/contacts</a></td>
            </tr>
            <tr>
              <td colspan="2"><g:message code="data.catalogue.ws0025.table0701" />:</td>
            </tr>
            <tr>
              <td colspan="2"><span class="code"><span class='entity'>GET</span> ${grailsApplication.config.grails.serverURL}/ws/{resource type}/{resource uid}/contacts/notifiable</span></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.ws0025.forexample" />:</td>
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/collection/co13/contacts/notifiable.json">${grailsApplication.config.grails.serverURL}/ws/collection/co13/contacts/notifiable</a></td>
            </tr>
            <tr>
              <td colspan="2"><g:message code="data.catalogue.ws0025.table0901" />:</td>
            </tr>
            <tr>
              <td colspan="2"><span class="code"><span class='entity'>GET</span> ${grailsApplication.config.grails.serverURL}/ws/contacts/{contact id}/authorised</span></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.ws0025.forexample" />:</td>
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/contacts/132/authorised.json">${grailsApplication.config.grails.serverURL}/ws/contacts/132/authorised</a></td>
            </tr>
          </table>
          ...
          <p><g:message code="data.catalogue.ws0025.des08" />.</p>
            ...
            <p><g:message code="data.catalogue.ws0025.des12" /> ${grailsApplication.config.grails.serverURL}/ws/{resource type}/{resource uid}/contacts/{contact id}</p>
          ...
          <table class="table">
            <colgroup><col width="55%"><col width="45%"></colgroup>
            <tr>
              <td colspan="2"><span class="code"><span class='entity'>GET</span> ${grailsApplication.config.grails.serverURL}/ws/eml/<strong>{uid}</strong></span></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.ws0026.table0101" />:</td>
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/eml/dr0">${grailsApplication.config.grails.serverURL}/ws/eml/dr0</a></td>
            </tr>
          </table>
          ...
          <table class="table">
            <colgroup><col width="55%"><col width="45%"></colgroup>
            <tr>
              <td colspan="2"><span class="code"><span class='entity'>GET</span> ${grailsApplication.config.grails.serverURL}/ws/citations/<strong>{listOfUIDs}</strong></span></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><a href="${grailsApplication.config.grails.serverURL}/ws/citations/dr368,dr105,dr357">${grailsApplication.config.grails.serverURL}/ws/citations/dr368,dr105,dr357</a></td>
            </tr>
          </table>
          ...
          <table class="table">
            <colgroup><col width="55%"><col width="45%"></colgroup>
            <tr>
              <td colspan="2"><span class="code"><span class='entity'>GET</span> ${grailsApplication.config.grails.serverURL}/lookup/inst/<strong>{institution-code}</strong>/coll/<strong>{collection-code}</strong></span></td>
            </tr>
            <tr>
          ...
          <table class="table">
            <colgroup><col width="55%"><col width="45%"></colgroup>
            <tr>
              <td colspan="2"><span class="code"><span class='entity'>GET</span> ${grailsApplication.config.grails.serverURL}/lookup/summary/<strong>{uid}</strong></span></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.ws0028.table0101" />:</td>
              <td><a href="${grailsApplication.config.grails.serverURL}/lookup/summary/dp28.json">${grailsApplication.config.grails.serverURL}/lookup/summary/dp28</a></td>
            </tr>
          </table>
          ...
          <table class="clean no-left-pad">
            <colgroup><col width="55%"><col width="45%"></colgroup>
            <tr>
              <td colspan="2"><span class="code"><span class='entity'>GET</span> ${grailsApplication.config.grails.serverURL}/lookup/taxonomicCoverageHints/<strong>{uid}</strong></span></td>
            </tr>
            <tr>
              <td><g:message code="data.catalogue.ws0030.table0101" />:</td>
              <td><a href="${grailsApplication.config.grails.serverURL}/lookup/taxonomyCoverageHints/co12.json">${grailsApplication.config.grails.serverURL}/lookup/taxonomyCoverageHints/co12</a></td>
            </tr>
          </table>
          ...
          <p><span class="code"><span class='entity'>GET</span> <a href="${grailsApplication.config.grails.serverURL}/lookup/downloadLimits">${grailsApplication.config.grails.serverURL}/lookup/downloadLimits</a></span></p>
      ...
      <div id="column-two">
        <div class="section infoColumn">
          ...
          <p>
            <a href="${grailsApplication.config.grails.serverURL}/ws/collection.json"><g:message code="data.catalogue.ct.lacs" /></a><br/>
            <a href="${grailsApplication.config.grails.serverURL}/ws/institution.json"><g:message code="data.catalogue.ct.lais" /></a><br/>
            <a href="${grailsApplication.config.grails.serverURL}/ws/dataProvider.json"><g:message code="data.catalogue.ct.ladps" /></a><br/>
            <a href="${grailsApplication.config.grails.serverURL}/ws/dataResource.json"><g:message code="data.catalogue.ct.ladrs" /></a><br/>
            <a href="${grailsApplication.config.grails.serverURL}/ws/dataHub.json"><g:message code="data.catalogue.ct.lahs" /></a><br/>
          </p>
          <p>
            <a href="${grailsApplication.config.grails.serverURL}/ws/collection/contacts.json"><g:message code="data.catalogue.ct.lmcfec" /></a><br/>
          </p>
