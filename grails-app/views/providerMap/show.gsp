    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="btn-toolbar mt-3">
                <g:form class="d-flex flex-grow-1">
                    ...
                    <g:actionSubmit class="edit btn btn-outline-dark ms-auto" action="edit" value="${message(code: 'default.button.edit.label', default: 'Edit')}" />
                </g:form>
            </div>
        </div>
    </body>
