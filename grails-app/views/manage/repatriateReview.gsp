        ...
        <table id="resource-table" class="resource-table table table-hover table-sm">
            <thead>
                <tr class="header">
                    ...
                    <th><g:message code="manage.extloadr.label06"/> <button type="btn btn-sm" onclick="invertColumn('.addResource'); return false"><span class="fa fa-check"></span></button></th>
                    <th><g:message code="manage.extloadr.label07"/> <button type="btn btn-sm" onclick="invertColumn('.updateMetadata'); return false"><span class="fa fa-check"></span></button></th>
                    <th><g:message code="manage.extloadr.label08"/> <button type="btn btn-sm" onclick="invertColumn('.updateConnection'); return false"><span class="fa fa-check"></span></button></th>
            ...
            <tr class="resource-scan-${res.status}">
                ...
                <td class="resource-mapping"><span id="existing-${rs}"><g:if test="${res.uid}">
                    ...
                    &nbsp; &nbsp; <span class="btn btn-outline-dark btn-sm" onclick="existingDialog('#existing-${rs}', '#resources-${rs}-uid'); return false"><g:message code="manage.extloadr.button01" default="..."/></span> </td>
